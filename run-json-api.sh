...
if [ ! -f http-json-1.15.0.jar ]; then
   wget -q https://github.com/digital-asset/daml/releases/download/v1.15.0/http-json-1.15.0.jar
fi

java -jar http-json-1.15.0.jar --ledger-host ledger.$DOMAIN \
