...
curl -L https://github.com/fullstorydev/grpcurl/releases/download/v1.8.0/grpcurl_1.8.0_linux_x86_64.tar.gz -o /tmp/grpcurl_1.8.0_linux_x86_64.tar.gz
cd /tmp
tar xvfx grpcurl_1.8.0_linux_x86_64.tar.gz
mv grpcurl /usr/local/bin/grpcurl
chmod u+x /usr/local/bin/grpcurl

cd ~
export TERM=xterm-256color
curl -sSL https://get.daml.com/ | sh /dev/stdin  1.10.0
